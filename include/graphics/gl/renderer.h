...
#include "graphics/gl/attributes.h"
...
class MaterialIndexBuffer : public UniformBlock {
   public:
    ...
    MaterialIndexBuffer() { glCreateBuffers(1, &m_glBuffer); };
...
class InstanceAttribBuffer {
   public:
    ...
    InstanceAttribBuffer() { glCreateBuffers(1, &m_glBuffer); }
...
class Renderer : public RendererState {
   ...
   private:
    ...
    void processCommand(
        ...
        m_drawIndirectBuffer.write(command.m_commands, GL_STREAM_DRAW);
